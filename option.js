...
const defaultProperties = {
  //created an object with default values to reset when required
  fontFamily: "sans",
  fontSize: 16,
  color: "#000000",
...
function onCellFocus(event) {
  ...
  cellNamePlaceholder.innerText /**setting the value of the text in the document to the element id */ =
    elementId; //setting the text inside the cell to the element id;
